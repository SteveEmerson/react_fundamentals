    ...
    <div className="main">
      <div className="mainDiv">
        ...
        <ul>
          ...
          <li>This app just scratches the surface of what is possible with React.</li>
